		...
		<Modal {...props} size="md" aria-labelledby="contained-modal-title-vcenter" centered>
			...
			<Modal.Body className="modal-bracket">
				<div>
					...
					<div>
						<label>Score</label>
						<input type="number" name="opponent1" defaultValue={match.opponent1?.score} onChange={changeMatch} />
						<label>Score</label>
						<input type="number" name="opponent2" defaultValue={match.opponent2?.score} onChange={changeMatch} />
					</div>
				</div>
				<div>
					<label>Result</label>
