								...
								<div className="row">
									{teams.map((team, idx) => (
										<div className="col-3" key={idx}>
											<div className="card text-white mb-3" style={{ maxWidth: "18rem", height: "550px" }}>
												<div className="card-header" style={{ backgroundColor: "#FFB562" }}>
													<div className="row">
														<div className="col-6">
															<span
																style={{
												...
												<div className="card-body" style={{ backgroundColor: "#FF8C00" }}>
													...
													<div className="row">
														<div className="col-8">
															...
															<p className="card-text">{team.MemberName1 && team.MemberName1}</p>
															<p className="card-text">{team.MemberName2 && team.MemberName2}</p>
															<p className="card-text">{team.MemberName3 && team.MemberName3}</p>
															<p className="card-text">{team.MemberName4 && team.MemberName4}</p>
															<p className="card-text">{team.MemberName5 && team.MemberName5}</p>
															<p className="text-center">
																<b>Benches</b>
															</p>
															<p className="card-text">{team.BenchMemberName1 && team.BenchMemberName1}</p>
															<p className="card-text">{team.BenchMemberName2 && team.BenchMemberName2}</p>
														</div>
														<div className="col-4 text-center">
															<p className="">
																<b>Pos.</b>
															</p>
															<p className="card-text">{team.CaptainName && "1"}</p>
															<p className="card-text">{team.MemberName1 && "2"}</p>
															<p className="card-text">{team.MemberName2 && "3"}</p>
															<p className="card-text">{team.MemberName3 && "4"}</p>
															<p className="card-text">{team.MemberName4 && "5"}</p>
															<h6 className="card-title">{""}</h6>
															<p className="card-text">{team.BenchMemberName1 && "1"}</p>
															<p className="card-text">{team.BenchMemberName2 && "2"}</p>
														</div>
													</div>
												</div>
											</div>
